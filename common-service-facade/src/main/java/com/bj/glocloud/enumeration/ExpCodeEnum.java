...
import com.bj.glocloud.utils.ExpPrefixUtil;
import static com.bj.glocloud.utils.ExpPrefixUtil.*;
 ...
 * <p>
 * PS:异常码一共由5位组成，前两位为固定前缀，请参考{@link com.bj.glocloud.utils.ExpPrefixUtil}
 */
public enum ExpCodeEnum implements Serializable {
    ...
    /**
     * Category Exception with Unified Prefix: ProdExpPrefix
     */
    ...
    /**
     * Brand Exception with Unified Prefix: ProdExpPrefix
     */
