...
import com.bj.glocloud.req.QueryReq;
 ...
 * @author Xionge
 * @date 2018/11/11
 * @description Request for User Query
 */
public class UserQueryReq extends QueryReq {
    ...
    /** 用户类型 {@link com.bj.glocloud.enumeration.user.UserTypeEnum} */
    private Integer userType;

    /** 账号状态 {@link com.bj.glocloud.enumeration.user.UserStateEnum } */
    ...
    /** 根据注册时间排序 {@link com.bj.glocloud.enumeration.OrderEnum} */
